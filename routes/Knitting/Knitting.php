...
Route::get('/knitting-party-detail-list', [KnittingPartyController::class, 'knittingPartyDetailList'])->name('knitting-party-detail-list')->middleware('permission:knitting-party-detail-list');
...
Route::get('/knitting-delete', [KnittingController::class, 'knittingDelete'])->name('knitting-delete');
...
Route::get('/delete-knitting-sale/{id}', [KnittingSaleController::class, 'deleteKnittingSale'])->name('delete-knitting-sale')->middleware('permission:delete-knitting-sale');
...
Route::get('/knitting-payment-list', [KnittingPartyController::class, 'knittingPaymentList'])->name('knitting-payment-list')->middleware('permission:knitting-payment-list');
Route::get('/knitting-payment-delete/{id}', [KnittingPartyController::class, 'knittingPaymentDelete'])->name('knitting-payment-delete')->middleware('permission:knitting-payment-delete');
