...
const headers = [
    { text: "ID", value: "id" },
    { text: "Name", value: "knitting_party.name" },
    { text: "Total Weight", value: "total_unit" },
    { text: "Available Weight", value: "available_unit" },
];

// Reactive data
const items = ref(page.props.knittings);
const knittingPayment = ref(page.props.knittingPayments || {});
...
// Show knitting party details in modal
function knittingPartyDetails() {
...
<template>
    ...
    <!-- Page Title -->
    <p class="text-2xl font-bold">Knitting Party Detail List</p>
